...
Cloudflow used to ship with full integrations with Apache Spark and Apache Flink, this used to be extremely useful for new comers that can quickly sketch up applications on multiple streaming engines.
