...
object CloudflowNativeSparkPlugin extends AutoPlugin {
  ...
  object autoImport {
    val sparkNativeCloudflowDockerInstructions =
      taskKey[Seq[sbtdocker.Instruction]]("Docker instructions to build the Cloudflow Spark Native Streamlet")
  ...
  override lazy val projectSettings = Seq(sparkNativeCloudflowDockerInstructions := {
